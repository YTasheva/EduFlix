...
const cards = [
    {
      ...
      price: "free",
      date: "12.03.24",
      topic: "React.js Front-End Development - The Complete Guide (incl Hooks, React Router, Redux)",
      image: education_1,
    ...
    },
    {
...

      {
        ...
        price: "30,00",
        date: "10.04.24",
        topic: "Start Learning Python. Future-Proof your Career with the Best Python Course on the Market",
        image: education_4,
        circleText: "DISCOVER MORE",
      },
      {
        ...
        price: "20,00",
        date: "16.08.24",
        topic: "Photoshop Tutorial for Begginers 2024. Everything you NEED to KNOW! Photoshopping your Drawings. Realistified! ",
        image: education_5,
        circleText: "90% match",
      },
      {
      ...
      },
      {
        ...
        price: "10,00",
        date: "20.05.24",
        topic: "JavaScript Mastery Complete Course. Tutorial For Begginers to Advanced. Ignite Your Front-End Mastery Series!",
        image: education_8,
        circleText: "95% match",
      },
